...
// source: zytherion/zytherion/query.proto
...
func (*QueryParamsRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_8f7a6c3ff4dfa03a, []int{0}
}
...
func (*QueryParamsResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_8f7a6c3ff4dfa03a, []int{1}
}
...
func init() {
	proto.RegisterType((*QueryParamsRequest)(nil), "zytherion.zytherion.QueryParamsRequest")
	proto.RegisterType((*QueryParamsResponse)(nil), "zytherion.zytherion.QueryParamsResponse")
}

func init() { proto.RegisterFile("zytherion/zytherion/query.proto", fileDescriptor_8f7a6c3ff4dfa03a) }

var fileDescriptor_8f7a6c3ff4dfa03a = []byte{
	// 282 bytes of a gzipped FileDescriptorProto
	0x1f, 0x8b, 0x08, 0x00, 0x00, 0x00, 0x00, 0x00, 0x02, 0xff, 0xe2, 0x92, 0xaf, 0xaa, 0x2c, 0xc9,
	0x48, 0x2d, 0xca, 0xcc, 0xcf, 0xd3, 0x47, 0xb0, 0x0a, 0x4b, 0x53, 0x8b, 0x2a, 0xf5, 0x0a, 0x8a,
	...
	0xff, 0xff, 0xdc, 0x3d, 0x65, 0xd2, 0xec, 0x01, 0x00, 0x00,
}
...
func (c *queryClient) Params(ctx context.Context, in *QueryParamsRequest, opts ...grpc.CallOption) (*QueryParamsResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/zytherion.zytherion.Query/Params", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Query_Params_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/zytherion.zytherion.Query/Params",
	}
...
var _Query_serviceDesc = grpc.ServiceDesc{
	ServiceName: "zytherion.zytherion.Query",
	...
	Metadata: "zytherion/zytherion/query.proto",
}
