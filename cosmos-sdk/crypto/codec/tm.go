...
import (
	...
	"github.com/cosmos/cosmos-sdk/crypto/keys/dilithium5"
...
func FromTmProtoPublicKey(protoPk tmprotocrypto.PublicKey) (cryptotypes.PubKey, error) {
	...
	case *tmprotocrypto.PublicKey_Dilithium5:
		return &dilithium5.PubKey{
			Key: protoPk.Dilithium5,
		}, nil
	default:
...
func ToTmProtoPublicKey(pk cryptotypes.PubKey) (tmprotocrypto.PublicKey, error) {
	...
	case *dilithium5.PubKey:
		return tmprotocrypto.PublicKey{
			Sum: &tmprotocrypto.PublicKey_Dilithium5{
				Dilithium5: pk.Key,
			},
		}, nil
	default:
